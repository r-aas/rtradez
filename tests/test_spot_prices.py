"""Tests for rtradez.data_sources.crypto.spot_prices."""
...
from rtradez.data_sources.crypto.spot_prices import *

class TestCryptoProvider:
    """Test cases for CryptoProvider."""

    def test_initialization(self, sample_data):
        """Test class initialization."""
        # Handle Enum classes
        if hasattr(CryptoProvider, "__members__"):
            # Test Enum values
            for member in CryptoProvider:
                assert isinstance(member, CryptoProvider)
            return
        ...
        try:
            ...
            try:
                instance = CryptoProvider(**sample_data.get("init_params", {}))
                assert instance is not None
    ...
    def test_get_defi_protocols_summary(self, sample_data):
        """Test get_defi_protocols_summary method."""
        instance = CryptoProvider(**sample_data.get("init_params", {}))
        
        try:
            result = instance.get_defi_protocols_summary(**sample_data.get("get_defi_protocols_summary_params", {}))
            assert result is not None
        except (TypeError, NotImplementedError, ValueError) as e:
            # Method may be abstract or require specific parameters
            pass
    ...
    def test_fetch_data(self, mock_get, sample_data):
        ...
        provider = CryptoProvider(**sample_data.get("provider_params", {}))
